...
- Build from scratch with modern tooling (Vite, React, Tailwind)
- Create a reliable dev environment from a corrupted mess
- Leverage AI intentionally through **custom GPT tooling**
- Document the journey so others (and future me) can learn too
...
- Security workflows + proactive monitoring

And most recently…

---

## 🛡 Wazuh Project: SIEM & Security Stack Deployment
...
- Preparing for honeypot integration (e.g. **T-Pot**, **Cowrie**) to simulate and monitor threat activity
- Planning dashboards and alert workflows for actionable insights

This project ties directly into my passion for blending **IT fundamentals**, **security awareness**, and **automation** into something hands-on and useful — not just academic.


---

## 🤖 GPT-Zenith – My AI Dev Assistant
...
- Help document, reflect, and organize my work like a second brain

> “It’s not just code support — it’s workflow clarity, mentorship energy, and a push to keep going.”

I built GPT-Zenith to grow *with* me, and now others can use it too 👇  
🧠 **[Try GPT-Zenith](https://chatgpt.com/g/g-6802bfdd7c4c8191afb0ddc99d00bf18-gpt-zenith)**
